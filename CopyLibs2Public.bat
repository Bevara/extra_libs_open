...
copy lib\win32\debug\*.lib ..\Access_open\extra_lib\lib\win32\debug\
copy lib\win32\release\*.lib ..\Access_open\extra_lib\lib\win32\release\
copy lib\win32\debug\*.dll ..\Access_open\bin\win32\debug\
copy lib\win32\release\*.dll ..\Access_open\bin\win32\release\
copy lib\win32\release\*.manifest ..\Access_open\bin\win32\release\
copy lib\win32\debug\*.plg ..\Access_open\bin\win32\debug\
copy lib\win32\release\*.plg ..\Access_open\bin\win32\release\
...
:XULSDK_copy
xcopy /i /e /q /y xulrunner-sdk ..\Access_open\extra_lib\include\xulrunner-sdk\
:DekTec_copy
...
:SDL_copy
copy SDL-1.2.15\include\ ..\Access_open\extra_lib\include\SDL\
copy SDL-1.2.15\lib\x86\*.lib ..\Access_open\extra_lib\lib\win32\debug\
copy SDL-1.2.15\lib\x86\*.lib ..\Access_open\extra_lib\lib\win32\release\
copy SDL-1.2.15\lib\x86\*.dll ..\Access_open\bin\win32\debug\
copy SDL-1.2.15\lib\x86\*.dll ..\Access_open\bin\win32\release\
IF "%1"=="all" GOTO win64
GOTO done
...
copy lib\x64\debug\*.lib ..\Access_open\extra_lib\lib\x64\debug\
copy lib\x64\release\*.lib ..\Access_open\extra_lib\lib\x64\release\
copy lib\x64\debug\*.dll ..\Access_open\bin\x64\debug\
copy lib\x64\release\*.dll ..\Access_open\bin\x64\release\
copy lib\x64\release\*.manifest ..\Access_open\bin\x64\release\
...
:SDL_copy
copy SDL-1.2.15\include\ ..\Access_open\extra_lib\include\SDL\
copy SDL-1.2.15\lib\x64\*.lib ..\Access_open\extra_lib\lib\x64\debug\
copy SDL-1.2.15\lib\x64\*.lib ..\Access_open\extra_lib\lib\x64\release\
copy SDL-1.2.15\lib\x64\*.dll ..\Access_open\bin\x64\debug\
copy SDL-1.2.15\lib\x64\*.dll ..\Access_open\bin\x64\release\
GOTO done
